...
async function sortAndSendData(tempData) {
    ...
    for (let i = 0; i < tempData.length; i++) {
        ...
        let calendar = await processData(tempUserData, diffDays, tempUserName)
        //console.log(calendar);
        let processedData = getStreakAndPercent(calendar, diffDays)
...
function processData(userData, diffDays, username) {
    ...
    if (userData.length !== 0 && diffDays<= 30) {
